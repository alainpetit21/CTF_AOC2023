...
def test_loading():
    challenge = Challenge()
    data = challenge.load_data("example.txt")
...
def test_run():
    ...
    assert challenge.lst_location[0] == 82
    assert challenge.lst_location[1] == 43
    assert challenge.lst_location[2] == 86
    assert challenge.lst_location[3] == 35
